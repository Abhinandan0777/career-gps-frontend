...
import TranscriptAnalysisDemo from './pages/TranscriptAnalysisDemo';
            ...
            <nav className="flex items-center gap-2">
              {isAuthenticated ? (
                <>
                  ...
                  {/* User Badge */}
                  <div className="ml-2 px-4 py-2 bg-gradient-to-r from-primary-50 to-purple-50 rounded-lg border border-primary-100">
                  ...
                  <button
                    onClick={logout}
                    className="ml-2 px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-all duration-200 font-medium shadow-sm hover:shadow-md transform hover:scale-105"
                  >
                    Logout
                  </button>
                </>
                ...
                <>
                  <Link
                    to="/login"
                    className="px-6 py-2.5 text-primary-600 hover:text-primary-700 hover:bg-primary-50 rounded-lg transition-all duration-200 font-medium"
                  >
                    Sign In
                  </Link>
                  <Link
                    to="/register"
                    className="px-6 py-2.5 gradient-primary text-white rounded-lg hover:shadow-lg transition-all duration-200 font-medium transform hover:scale-105"
                  >
                    Get Started
                  </Link>
                </>
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center py-16 px-4">
        <div className="inline-block mb-4 px-4 py-2 bg-gradient-to-r from-primary-100 to-purple-100 rounded-full">
          <span className="text-primary-700 font-semibold text-sm">🚀 AI-Powered Career Navigation</span>
        </div>
        
        <h2 className="text-5xl sm:text-6xl font-bold mb-6 bg-gradient-to-r from-primary-600 via-purple-600 to-pink-600 bg-clip-text text-transparent leading-tight">
          Navigate Your Career
          <br />
          <span className="text-4xl sm:text-5xl">With Confidence</span>
        </h2>
        ...
        {!isAuthenticated && (
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/register"
              className="group px-8 py-4 gradient-primary text-white rounded-xl hover:shadow-2xl transition-all duration-300 font-semibold text-lg transform hover:scale-105 flex items-center space-x-2"
            >
            ...
            <Link
              to="/login"
              className="px-8 py-4 bg-white text-primary-600 border-2 border-primary-200 rounded-xl hover:border-primary-400 hover:shadow-lg transition-all duration-300 font-semibold text-lg"
            >
              Sign In
            </Link>
          </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-16 px-4">
        ...
        <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3">Learning Roadmaps</h3>
          <p className="text-gray-600 leading-relaxed">
        ...
        <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
          <div className="w-14 h-14 bg-gradient-to-br from-orange-500 to-pink-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
          </div>
          <h3 className="text-xl font-bold text-gray-900 mb-3">Curated Courses</h3>
          <p className="text-gray-600 leading-relaxed">
      ...
      {/* Stats Section */}
      <div className="mt-20 bg-gradient-to-r from-primary-600 to-purple-600 rounded-3xl p-12 text-white">
